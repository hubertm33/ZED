...
lines_part_res_name_analysis_more_than_3 <-transform(lines_part_res_name_analysis_more_than_2, res_name = factor(res_name))
...
inTraining <- 
    createDataPartition(
        ...
        y = lines_part_res_name_analysis_more_than_3$res_name,
...
geom_density(aes(res_name, fill="green"), lines_part_res_name_analysis_more_than_3) + 
 geom_density(aes(res_name, fill="red"), training) + 
 geom_density(aes(res_name, fill="blue"), testing) + 
 theme_minimal()

lines_part_res_name_analysis_more_than_3$res_name <- factor(lines_part_res_name_analysis_more_than_3$res_name)

training <- lines_part_res_name_analysis_more_than_3[ inTraining,]
testing  <- lines_part_res_name_analysis_more_than_3[-inTraining,]
...
training2 <- droplevels(training)
fit <- train(as.factor(res_name) ~ .,
             data = training,
             method = "rf",
             trControl = ctrl,
